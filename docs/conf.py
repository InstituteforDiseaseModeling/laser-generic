...
templates_path = ["."]
extlinks = {
    "issue": ("https://github.com/InstituteforDiseaseModeling/laser-generic/issues/%s", "#%s"),
    "pr": ("https://github.com/InstituteforDiseaseModeling/laser-generic/pull/%s", "PR #%s"),
}

html_theme = "sphinx_rtd_theme"
html_theme_options = {
    # "githuburl": "https://github.com/InstituteforDiseaseModeling/laser-generic/",
}
